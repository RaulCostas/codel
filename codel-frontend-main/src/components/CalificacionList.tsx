                ...
                <div className="flex gap-2 w-full md:max-w-md">
                    <div className="relative flex-grow">
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-gray-800 dark:text-white bg-white dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400"
                        />
                        ...
                        {calificaciones.map((cal, index) => (
                            <tr key={cal.id} className="hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="p-3 text-gray-800 dark:text-gray-300 font-medium">
                                    {formatFullName(cal.personal)}
                                </td>
                                <td className="p-3 text-gray-800 dark:text-gray-300">
                                    {formatFullName(cal.paciente)}
                                </td>
