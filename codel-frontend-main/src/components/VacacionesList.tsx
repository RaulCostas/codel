    ...
    const exportToExcel = async () => {
        try {
            ...
            const excelData = allData.map(v => ({
                ...
                'Personal': v.personal ? formatFullName(v.personal) : 'N/A',
    ...
    const exportToPDF = async (filteredPersonalId: string | null) => {
        try {
            ...
            if (personal) {
                ...
                const fullName = formatFullName(personal);
            ...
            const tableData = allVacaciones.map(v => [
                v.id,
                formatDate(v.fecha),
                v.personal ? formatFullName(v.personal) : 'N/A',
                v.tipo_solicitud,
                v.cantidad_dias,
                        ...
                        <tbody>
                            ${allVacaciones.map(v => `
                                <tr>
                                    ...
                                    <td>${v.personal ? formatFullName(v.personal) : 'N/A'}</td>
                        ...
                        {loading ? (
                            ...
                            <tr key={vacacion.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="p-3 text-gray-800 dark:text-gray-300">
                                    {vacacion.personal ? formatFullName(vacacion.personal) : 'Personal Eliminado'}
                                </td>
