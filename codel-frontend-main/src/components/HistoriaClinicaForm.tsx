    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (formData.estadoPresupuesto === 'terminado') {
            if (formData.proformaId && currentProformaDetails.length > 0) {
                ...
                // Todos completos, mostrar modal de firma
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 transition-colors duration-300">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                disabled={formData.pagado === 'SI'}
                                className={`w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 ${formData.pagado === 'SI' ? 'opacity-60 cursor-not-allowed' : ''}`}
                                required
                            />
                        </div>
                    </div>
            ...
            <FirmaModal
                ...
                onSign={(firmaData) => handleSave(firmaData)}
            />
        </div >
    );
};
