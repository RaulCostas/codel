...
const PropuestasForm: React.FC = () => {
    ...
    // Global discount per tab: { 'A': 10, 'B': 0 }
    const [tabDiscounts, setTabDiscounts] = useState<Record<string, number>>({
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl border border-gray-100 dark:border-gray-600 mb-8 shadow-sm">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        {isReadOnly ? (
                            <div className="w-full mt-1 px-4 py-2 bg-gray-100 dark:bg-gray-800 border border-transparent rounded-xl text-gray-800 dark:text-gray-200 font-medium h-[42px] flex items-center">
                                {formatDate(fecha)}
                            </div>
                        ) : (
                            <input
                                ...
                                className="w-full mt-1 px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-800 dark:text-gray-200"
                            />
                        )}
                    </div>
                </div>
                ...
                <div className={`p-6 rounded-xl mb-8 border transition-all duration-300 ${editingIndex !== null ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800' : 'bg-gray-50 dark:bg-gray-700/30 border-gray-200 dark:border-gray-600'}`}>
                                ...
                                <div className="flex gap-2">
                                    <div className="relative flex-grow">
                                        <select
                                            ...
                                            onChange={(e) => {
                                                setSelectedArancelId(Number(e.target.value));
                                            }}
                                            className="w-full pl-10 pr-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-800 dark:text-gray-200 appearance-none transition-all"
                                        >
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            className={`w-full md:w-auto min-w-[200px] py-2 px-4 rounded-xl shadow-md font-semibold text-white text-sm transition-all transform hover:-translate-y-0.5
                                ${editingIndex !== null
                        ...
                        {editingIndex !== null && (
                            <button
                                onClick={cancelEdit}
                                className="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded transition-all flex items-center gap-2">
                                            ...
                                            <td className="px-4 py-3 whitespace-nowrap text-center text-sm font-medium">
                                                <div className="flex items-center justify-center gap-2">
                                                    <button
                                                        ...
                                                        className="p-1.5 bg-transparent text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded transition-all"
                                                        title="Editar"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-1.5 bg-transparent text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300 hover:bg-red-100 dark:hover:bg-red-900/50 rounded transition-all"
                                                        title="Eliminar"
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        ...
                        <textarea
                            ...
                            disabled={isReadOnly}
                            className="w-full h-32 px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-800 dark:text-gray-200 resize-none transition-all"
                        ...
                        <div className="flex justify-start gap-4 mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
                            {!isReadOnly && (
                                <button
                                    ...
                                    className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-xl shadow-md transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
