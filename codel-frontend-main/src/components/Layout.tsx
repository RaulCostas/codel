               ...
               <nav className="sidebar-nav">
                    <ul className="nav-list">
                        ...
                        {hasAccess('pacientes') && (
                            <li className="nav-item">
                                <div
                                    className={`nav-link ${isGestionOpen || isActive('/pacientes') || isActive('/pacientes-deudores') || isActive('/pacientes-pendientes') || isActive('/arancel') || isActive('/recetario') ? 'active' : ''}`}
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        style={{ transform: isGestionOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.3s' }}
                                    >
                                ...
                                {isGestionOpen && (
                                    <ul className="submenu-list" style={{ paddingLeft: '20px', listStyle: 'none', background: 'rgba(0,0,0,0.05)' }}>
                                        <li className="nav-item">
                                            <Link to="/pacientes" className={`nav-link ${isActive('/pacientes')}`} onClick={closeSidebar}>
                                                Lista de Pacientes
                                            </Link>
                                        </li>
                                        ...
                                        {hasAccess('pacientes-deudores') && (
                                            <li className="nav-item">
                                                <Link to="/pacientes-deudores" className={`nav-link ${isActive('/pacientes-deudores')}`} onClick={closeSidebar}>
                                                    Deudores
                                                </Link>
                                            </li>
                                        )}
                                        {hasAccess('pacientes-pendientes') && (
                                            <li className="nav-item">
                                                <Link to="/pacientes-pendientes" className={`nav-link ${isActive('/pacientes-pendientes')}`} onClick={closeSidebar}>
                                                    Pendientes
                                                </Link>
                                            </li>
                                        )}
                                        {hasAccess('arancel') && (
                                            <li className="nav-item">
                                                <Link to="/arancel" className={`nav-link ${isActive('/arancel')}`} onClick={closeSidebar}>
                                                    Aranceles
                                                </Link>
                                            </li>
                                        )}
                                        {hasAccess('recetario') && (
                                            <li className="nav-item">
                                                <Link to="/recetario" className={`nav-link ${isActive('/recetario')}`} onClick={closeSidebar}>
                                                    Recetario
                                                </Link>
                                            </li>
                                        )}
                        ...
                        {hasAccess('pacientes') && (
                            <li className="nav-item">
                                <div
                                    ...
                                    onClick={() => setIsSeguroOpen(!isSeguroOpen)}
                                    style={{ cursor: 'pointer', justifyContent: 'space-between' }}
                                >
                                    <div style={{ display: 'flex', alignItems: 'center' }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
                                    ...
                                    <svg
                                        ...
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                        style={{ transform: isSeguroOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.3s' }}
                                    >
                                        <polyline points="6 9 12 15 18 9"></polyline>
                                    </svg>
                                </div>
                ...
                <header className="top-header">
                    ...
                    <div className="header-actions">
                        ...
                        <div className="header-buttons">
                            {/* Selector Modificado: Modalidad Clínica Única (CODEL) */}
                            <ThemeToggle />
