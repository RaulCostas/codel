...
const PedidosForm: React.FC<PedidosFormProps> = ({ isOpen, onClose, id, onSaveSuccess }) => {
    ...
    const fetchInventario = async () => {
        try {
            const url = '/inventario?limit=9999';
                ...
                <div className="p-6">
                    <div className="flex items-center justify-between mb-6 border-b dark:border-gray-700 pb-4">
                        <h2 className="text-2xl font-bold text-gray-800 dark:text-white flex items-center gap-3">
                            <span className="p-2 bg-orange-100 dark:bg-orange-900 rounded-xl text-orange-600 dark:text-orange-300">
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3498db] bg-white text-gray-900 dark:bg-gray-700 dark:text-gray-100"
                                        required
                                    />
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4 items-end bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border dark:border-gray-600">
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className="w-full pl-8 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all bg-white text-gray-900 dark:bg-gray-600 dark:text-gray-100"
                                    >
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="relative w-24">
                                        ...
                                        <input
                                            ...
                                            placeholder="0"
                                            className="w-full pl-6 px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-xl text-right focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all bg-white text-gray-900 dark:bg-gray-700 dark:text-gray-100"
                                        />
                                    </div>
                                </div>
