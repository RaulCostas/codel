...
const PresupuestoList: React.FC = () => {
    ...
    const fetchProformas = async (pacienteId: number) => {
        try {
            const url = `/proformas/paciente/${pacienteId}`;
    ...
    const generatePDF = async (proforma: Proforma, action: 'print' | 'download' | 'blob', includePaymentInfo: boolean = true) => {
        ...
        doc.setFontSize(9);
        doc.setFont('helvetica', 'bold');
        const clinicName = clinicSignature ? formatFullName(clinicSignature.usuario) : 'CODEL';
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider no-print">Firma</th>
