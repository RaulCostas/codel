...
const Utilidades: React.FC = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const ingresosSeguros = sum(resSeguros.data, 'seguro');
            ...
            const totalIngresos = { bs: ingresos.bs + ingresosSeguros.bs, sus: ingresos.sus + ingresosSeguros.sus };
            const totalEgresos = {
            ...
            setStats({
                ...
                ingresosSeguros: { label: 'Ingresos por Pagos de Seguros', ...ingresosSeguros },
                                                ...
                                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                    ...
                                                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                        {selectedDetail.items.length > 0 ? selectedDetail.items.map((item) => (
                                                            ...
                                                            <tr>
                                                                <td colSpan={selectedDetail.title.includes('Ingresos') ? 6 : selectedDetail.title.includes('Egresos Diarios') ? 4 : selectedDetail.title.includes('Pagos a Laboratorios') ? 6 : selectedDetail.title.includes('Pagos de Pedidos') ? 5 : selectedDetail.title.includes('Pagos a Doctores') ? 4 : selectedDetail.title.includes('Pagos de Gastos') ? 4 : selectedDetail.title.includes('Seguros') ? 5 : 3} className="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400 font-light italic">No hay registros</td>
                                                            </tr>
                                                        )}
                                                    </tbody>
                                                </table>
