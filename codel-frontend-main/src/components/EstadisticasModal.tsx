...
const response = await api.get(`/personal?${params}`);
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] p-2 sm:p-4">
            <div className="bg-white dark:bg-gray-700 rounded-xl shadow-xl max-w-2xl w-full max-h-[95vh] overflow-y-auto">
                <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    <h3 className="text-lg sm:text-2xl font-bold text-gray-800 dark:text-white transition-all">
                        Estadísticas de Calificaciones
                    </h3>
                    <button
                        onClick={onClose}
                        className="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-3 sm:px-4 rounded-xl transition-all transform hover:-translate-y-0.5 active:scale-95 text-sm sm:text-base flex items-center gap-2 shadow-md">
                        <X size={18} />
                        Cerrar
                    </button>
                </div>
                ...
                <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-all"
                                >
                    ...
                    <div className="flex justify-center mt-3 sm:mt-4">
                        <button
                            ...
                            className="w-auto px-6 sm:px-8 bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 sm:py-3 rounded-xl transition-all transform hover:-translate-y-0.5 active:scale-95 flex items-center justify-center gap-2 text-sm sm:text-base shadow-md"
                        >
