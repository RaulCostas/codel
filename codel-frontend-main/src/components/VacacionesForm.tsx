                    ...
                    <div className="p-6">
                        <div className="flex items-center justify-between mb-6 border-b dark:border-gray-700 pb-4">
                            <h2 className="text-2xl font-bold text-gray-800 dark:text-white flex items-center gap-3">
                                <span className="p-2 bg-cyan-100 dark:bg-cyan-900 rounded-xl text-cyan-600 dark:text-cyan-300">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className="w-full pl-10 p-2 border border-gray-300 rounded-xl transition-all focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                        required
                                    >
