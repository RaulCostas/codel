    ...
    async generateProformasPdf(paciente: any, proformas: any[]): Promise<Buffer> {
        return new Promise((resolve, reject) => {
            ...
            proformas.forEach((p, index) => {
                ...
                content.push({
                    text: [
                        { text: 'NOTA: CLINICA DENTAL ', bold: true },
                    ...
                    columns: [
                        {
                            ...
                            stack: [
                                ...
                                { text: 'CLINICA DENTAL', alignment: 'center', margin: [0, 5, 0, 0], width: 120 }
                            ],
                            alignment: 'center'
                        },
                        {
